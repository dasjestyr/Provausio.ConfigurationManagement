<template>
    <v-layout row justify-center>
        <v-dialog persistent max-width="500px" v-model="show">
            <v-card>
                <v-card-title>
                    <span class="headline">Create a new environment</span>
                </v-card-title>
                <v-card-text>
                ...
                <v-card-actions style="margin-right: 5px">
                    ...
                    <v-btn color="secondary" @click=confirmationCallback>Create</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>        
    </v-layout>
...
export default {
    props: ['id', 'confirmationCallback', 'model'],
    methods: {
        cancel() {
